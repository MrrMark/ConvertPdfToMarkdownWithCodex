...
- M08은 Q118에서 내부 IR 기반 serializer boundary, Q119에서 table confidence v2, Q120에서 native hybrid chunking v2, Q121에서 layout sidecar diagnostics, Q122에서 region OCR evidence v2, Q123에서 OCR backend registry expansion을 완료했고, Q124-Q125에서 Docling runtime 의존 없이 `pdf2md` 네이티브 figure/domain 구조를 강화하는 active 작업으로 관리한다.
...
- fast output profile과 sidecar scope(Q102 완료)
...
- table confidence 강화(Q119 완료)
- native hybrid chunking 강화(Q120 완료)
- layout sidecar 강화(Q121 완료)
- figure semantics 강화(Q124)
