...
- M06은 Q98에서 structure marker OCR lazy 처리, Q99에서 page worker chunked parallelization, Q100에서 OCR page parallelization을 완료했고, Q101-Q102에서 남은 변환 속도 병목을 품질 보존 방식으로 줄이는 성능 개선 트랙으로 관리한다.
