...
대형 technical spec은 `pdf2md_plan_large_spec_conversion`으로 page-window, domain adapter recommendation, performance profile 권고를 확인한 뒤 page-window tool을 사용합니다.
