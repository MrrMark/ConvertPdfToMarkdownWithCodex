...
- 현재 active quality backlog는 Q105입니다. 우선순위는 Docling 벤치마크 결과 기반 확장 설계입니다.
- 완료된 Q34-Q104 품질 개선 명세와 구현 결과는 `docs/QUALITY_IMPROVEMENT_IMPLEMENTED_SPECS.md`에서 확인합니다.
