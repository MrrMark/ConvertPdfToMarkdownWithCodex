...
- Q80: real corpus structure marker OCR/provenance hardening
...
- 구조 마커 OCR early stop/cache 추가 최적화는 Q81로 남긴다.
- expected HTML fallback warning과 partial success 정책 정리는 Q82로 남긴다.
