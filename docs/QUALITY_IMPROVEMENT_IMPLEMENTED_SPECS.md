...
- Q85-Q89: RAG preset warning calibration, technical table triage, technical domain profile UX, storage/security adapter expansion, preset evaluation score gate
