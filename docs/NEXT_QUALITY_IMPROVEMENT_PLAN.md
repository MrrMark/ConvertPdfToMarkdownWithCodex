...
| 순서 | 작업 | 상태 | 완료 기준 |
| --- | --- | --- | --- |
| 3 | Q154. 빈 표 억제 및 벡터 도식 보존 | 구현·검증 완료, PR merge 대기 | 잘못된 표 4개 제거, 도식 3개 보존, 실제 표 유지 |
| 4 | Q155. 중첩 표 구조 보존 | 구현·로컬 검증 완료, PR merge 대기 | 부모 셀 안 HTML 중첩 표, 구조 메타데이터, 중복 검색 청크 방지 |
