...
class ReportSummary(BaseModel):
    ...
    figure_description_backend: Optional[str] = None
    figure_description_record_count: int = 0
    figure_description_file_count: int = 0
    figure_description_low_confidence_count: int = 0
    figure_description_skipped_no_evidence_count: int = 0
    figure_description_review_required_count: int = 0
    figure_description_chunk_record_count: int = 0
    figure_structure_extraction: bool = False
    figure_structure_record_count: int = 0
    figure_structure_file_count: int = 0
    figure_structure_low_confidence_count: int = 0
    figure_structure_skipped_no_structure_count: int = 0
    figure_structure_review_required_count: int = 0
...
class FigureDescriptionEvalSummary(BaseModel):
    ...
    missing_review_metadata_count: int = 0
    markdown_inserted_count: int = 0
    invalid_generated_scope_count: int = 0
    error_count: int = 0
    warning_count: int = 0
    passed: bool = True
