...
SCHEMA_FILES: dict[str, type] = {
    ...
    "conversion_state.schema.json": ConversionState,
    "interrupted_conversion_report.schema.json": InterruptedConversionReport,
    ...
    "plan_apply_report.schema.json": PlanApplyReport,
    ...
    "latest_ocp_datacenter_nvme_ssd_benchmark_report.schema.json": LatestOcpDatacenterNvmeSsdBenchmarkReport,
    "latest_ssd_security_spec_benchmark_report.schema.json": LatestSsdSecuritySpecBenchmarkReport,
    "ocr_backend_probe_report.schema.json": OCRBackendProbeReport,
    "figure_description_eval_report.schema.json": FigureDescriptionEvalReport,
